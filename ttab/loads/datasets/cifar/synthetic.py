...
if wandlibrary is not None and hasattr(wandlibrary, 'MagickMotionBlurImage'):
    ...
    warnings.warn(
        "MagickMotionBlurImage is not available. Synthetic motion blur corruption will be disabled."
    )
